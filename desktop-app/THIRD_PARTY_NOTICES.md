...
ANIdesktop bundles these open-source libraries through npm:

- [Vidstack Player](https://github.com/vidstack/player), version 1.15.6 — MIT License.
- [electron-updater](https://github.com/electron-userland/electron-builder/tree/master/packages/electron-updater), version 6.8.9, MIT License.
