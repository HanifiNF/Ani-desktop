...
const api: AniDesktopApi = {
  ...
  episodeUpdates: () => ipcRenderer.invoke("episode-updates:status"),
  checkEpisodeUpdates: (force) => ipcRenderer.invoke("episode-updates:check", force),
  dismissEpisodeUpdate: (id) => ipcRenderer.invoke("episode-updates:dismiss", id),
  markEpisodeUpdateRead: (id) => ipcRenderer.invoke("episode-updates:mark-read", id),
  onEpisodeUpdatesChange: (listener) => subscribe("episode-updates:change", listener),
  onOpenEpisodeUpdates: (listener) => subscribe("episode-updates:open", listener),
