...
export default function BrowseDetail({ anime, resolving, error, onBack, onRetry, onSearch }: { anime: BrowseAnime; resolving: boolean; error?: string; onBack: () => void; onRetry: () => void; onSearch: () => void }) {
