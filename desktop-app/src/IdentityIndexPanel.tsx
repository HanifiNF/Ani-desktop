...
export default function IdentityIndexPanel({ saved, draft, onChange }: { saved: Settings; draft: Settings; onChange: (settings: Settings) => void }) {
  ...
  return <div className="group"><h3>Anime information</h3><div className="box">
    <div className="r"><span className="k">Series details from AniList<small>Synopsis, studio, status, related seasons, and the ids that group one anime across sources. Titles of series you open are sent to AniList; answers are kept locally and refreshed by age.</small></span>
